...
export const adminHomeworkRoutes: RouteRecordRaw[] = [
  ...
  { path: 'homework/edit', name: 'AdminHomeworkCreate', component: AdminHomeworkEditView, meta: { title: '新增作业', icon: EditOutlined, group: homeworkGroup, order: 31, requiresAuth: true, audience: 'admin', summary: '创建作业并配置基础信息。', hideInMenu: true } },
  ...
  { path: 'homework/assign', name: 'AdminHomeworkAssignHub', component: AdminHomeworkAssignView, meta: { title: '布置作业', icon: ScheduleOutlined, group: homeworkGroup, order: 33, requiresAuth: true, audience: 'admin', summary: '按班级范围与截止时间布置作业。', hideInMenu: true } },
  ...
  { path: 'homework/submissions', name: 'AdminHomeworkSubmissionsHub', component: AdminHomeworkSubmissionsView, meta: { title: '提交记录', icon: FileDoneOutlined, group: homeworkGroup, order: 34, requiresAuth: true, audience: 'admin', summary: '查看各作业提交情况并进入批改。', hideInMenu: true } },
