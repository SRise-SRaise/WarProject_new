...
class EduExerciseItemServiceImplTest {
    ...
    void shouldBuildFilterConditionsForExerciseItemQuery() {
        ...
        setField(request, "current", 1);
        setField(request, "pageSize", 10);
    ...
    @Test
    void shouldAllowMissingExerciseIdWhenAddingExerciseItem() {
        ...
        assertDoesNotThrow(() -> eduExerciseItemService.validEduExerciseItem(item, true));
    }
