...
export const adminExamRoutes: RouteRecordRaw[] = [
  ...
  { path: 'question-types', name: 'AdminQuestionTypes', redirect: { name: 'AdminQuestionBank' }, meta: { title: '题型管理', icon: ReadOutlined, group: examGroup, order: 51, requiresAuth: true, audience: 'admin', summary: '题型管理已合并到题库与题型管理页面。', hideInMenu: true } },
  { path: 'papers', name: 'AdminPaperList', component: AdminPaperListView, meta: { title: '试卷管理', icon: ReadOutlined, group: examGroup, order: 52, requiresAuth: true, audience: 'admin', summary: '围绕共享题库组织试卷草稿与待发布卷。' } },
  ...
  { path: 'scores/summary', name: 'AdminScoreSummary', component: AdminScoreSummaryView, meta: { title: '成绩汇总', icon: ScheduleOutlined, group: examGroup, order: 55, requiresAuth: true, audience: 'admin', summary: '从共享题库、提交记录和平均分角度查看考试结果。' } },
]
