    ...
    children: [
      {
        ...
        meta: {
          ...
          shell: 'student',
          navLabel: '考试',
          summary: '查看可参加考试、已提交试卷与待批改状态。',
        },
      },
      {
        path: ':id/take',
        name: 'StudentExamTake',
        component: ExamTakeView,
        meta: {
          title: '开始答题',
          requiresAuth: true,
          audience: 'student',
          shell: 'student',
          summary: '在统一答题页中完成本场考试，支持倒计时和答题卡。',
        },
      },
      {
        path: ':id/result',
...
export const adminExamRoutes: RouteRecordRaw[] = [
  {
    ...
    component: AdminQuestionBankView,
    meta: { title: '题库管理', icon: FileSearchOutlined, group: examGroup, order: 50, requiresAuth: true, audience: 'admin', summary: '集中维护所有题目资源，支持多种题型的增删改查操作。' },
  },
  {
    path: 'papers',
    name: 'AdminPaperList',
    component: AdminPaperListView,
    meta: { title: '试卷管理', icon: ContainerOutlined, group: examGroup, order: 52, requiresAuth: true, audience: 'admin', summary: '围绕共享题库组织试卷草稿与待发布卷。' },
  },
  {
    path: 'exams',
    name: 'AdminExamList',
    component: AdminExamListView,
    meta: { title: '考试管理', icon: ScheduleOutlined, group: examGroup, order: 53, requiresAuth: true, audience: 'admin', summary: '查看考试安排、状态、参与人数与提交进度。' },
  },
  {
    path: 'exams/records/:id',
    name: 'AdminExamRecords',
    component: AdminExamRecordsView,
    meta: { title: '考试记录', icon: ScheduleOutlined, group: examGroup, order: 54, requiresAuth: true, audience: 'admin', summary: '查看单场考试的学生记录与风险提示。', hideInMenu: true },
  },
  {
    path: 'scores/summary',
    name: 'AdminScoreSummary',
    component: AdminScoreSummaryView,
    meta: { title: '成绩分析与批改', icon: BarChartOutlined, group: examGroup, order: 55, requiresAuth: true, audience: 'admin', summary: '查看考试成绩统计，批改简答题和编程题。' },
  },
]
